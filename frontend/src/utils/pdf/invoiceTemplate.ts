...
<div class="page">
  ...
  <div class="header">
    ...
    <div class="header-right">
      <div class="invoice-label">Nota de plata</div>
  ...
  <div class="body">
    ...
    <!-- PROPERTY -->
    <div class="section-label">Proprietate inchiriata</div>
    ...
    <!-- PAYMENT TABLE -->
    <div class="section-label">Detalii plata</div>
    <table>
      <thead>
        <tr>
          <th>Descriere</th>
  ...
  <!-- FOOTER -->
  <div class="footer">
    <div class="footer-note">Multumim pentru incredere. Document generat automat.</div>
