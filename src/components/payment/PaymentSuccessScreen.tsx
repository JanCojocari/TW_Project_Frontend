...
import { LABELS } from "../../types/paymentPageConfig";
...
const PaymentSuccessScreen = () => (
    <Box sx={{ minHeight: "100vh", bgcolor: "background.default", display: "flex", alignItems: "center", justifyContent: "center", pt: 8 }}>
        <Paper elevation={2} sx={{ p: { xs: 4, md: 6 }, borderRadius: 4, textAlign: "center", maxWidth: 460, mx: 2, border: `1px solid ${colors.border}` }}>
            ...
            <Typography variant="h5" fontWeight={900} mb={1} letterSpacing="-0.5px">{LABELS.successTitle}</Typography>
            <Typography color="text.secondary" mb={3}>{LABELS.successMessage}</Typography>
            <Typography variant="body2" color="text.secondary">Ești redirecționat către Dashboard...</Typography>
        </Paper>
    </Box>
);
