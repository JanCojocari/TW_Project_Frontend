...
export default function Settings() {
    // TODO: înlocuiește MOCK_USER cu date reale din AuthContext / GET /api/users/{id}
    const {
    ...
    return (
        <Stack spacing={3} sx={{ maxWidth: 720, mx: "auto", py: 4, px: { xs: 2, md: 0 } }}>
            ...
            <BalanceSection
                balance={profile.accountBalance}
            ...
            <Snackbar open={!!success} autoHideDuration={4000} onClose={clearSuccess}
